...
var temperaturePeriodCharacteristic;

/**
 * Function that updates the HTML element according to the temperature
 * characteristic.
 */
function temperatureChanged(event) {
    document.getElementById("temperature").innerHTML = event.target.value.getInt8(0);
}

/**
 * Function that updates the HTML number input according to the temperature
...
/**
 * Function that updates the temperature period using the corresponding
